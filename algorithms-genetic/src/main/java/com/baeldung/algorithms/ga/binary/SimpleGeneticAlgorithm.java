...
public class SimpleGeneticAlgorithm {
    ...
    private static byte[] solution = new byte[16];
    public static String check1;
    public static String check2;

    public int runAlgorithm(int populationSize, String solution) {
        if (solution.length() != SimpleGeneticAlgorithm.solution.length) {
            throw new RuntimeException("The solution needs to have " + SimpleGeneticAlgorithm.solution.length + " bytes" + "Currently:" + solution.length() );
        }
...
//        System.out.println(solution.length());
    ...
    public void putpopulation(String pop1, String pop2){
        this.check1 = pop1;
        this.check2 = pop2;
    }
