...
//    private String check2 ="0101111100001111";
    ...
    private String check = SimpleGeneticAlgorithm.check1 ;
    private String check2 = SimpleGeneticAlgorithm.check2;
...
//             System.out.println("Single gene value is:" +  genes[i]);
    ...
    public void combination (String check1, String check2){
        this.check = check1;
        this.check2 = check2;
