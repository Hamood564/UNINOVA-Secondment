...
public class Constants {
    ...
    public static final String DFSERVICE_TRANSPORT = "dfservice_transport";
        public static final String DFSERVICE_REQUEST = "dfservice_request";
        public static final String DFSERVICE_RESOURCE = "dfservice_resource";
        public static final String DFSERVICE_LOCATION = "dfservice_location";
    //Ontologies
    public static final String ONTOLOGY_TRANSPORT = "ont_tra_req";
     public static final String ONTOLOGY_RESOURCE = "ont_res_req";
    ...
    public static String ONTOLOGY_LOCATION = "dfservice_location";
