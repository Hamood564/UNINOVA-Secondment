    ...
    public void setup() {
        ...
        try {
            ...
            for (Iterator<String> iterator = mySkills.iterator(); iterator.hasNext();) {
                String nextSkill = iterator.next();
                ServiceDescription sd = new ServiceDescription();
                sd.setName(nextSkill);
        ...
        this.addBehaviour(new ResourceLocation(this, MessageTemplate.and(MessageTemplate.MatchPerformative(ACLMessage.REQUEST), MessageTemplate.MatchOntology(Constants.ONTOLOGY_RESOURCE))));
