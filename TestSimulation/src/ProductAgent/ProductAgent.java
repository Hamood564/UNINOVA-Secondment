...
//            DFAgentDescription[] LRAfound= DFInteraction.SearchInDF(Constants.DFSERVICE_LOCATION, this);
//            LRAfound[0].getAllServices();
//            System.out.println( "The Services are:" + LRAfound.toString());
...
//            System.out.println("Transporting: "+TRAfound[0].getName());                
            ...
            //else provide location to move PA to RA location
                ...
                System.out.println("PA  Resource Agent: " + MRAsFound[0].getName());
